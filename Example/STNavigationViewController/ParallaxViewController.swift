...
class ParallaxViewController: ViewController {
  ...
  override func commonInit() {
    super.commonInit()
    self.contentView.backgroundColor = UIColor.yellow.withAlphaComponent(0.5)
  }
  ...
  override func getPopAnimatedTransitioning(from fromVC: UIViewController,
    ...
    let animator = ParalaxPopAnimator()
